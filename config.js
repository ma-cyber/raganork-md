...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'Le Souverain Bot;Skl11;0;https://i.imgur.com/LwJyowH.jpeg;I',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'on',
    HANDLERS: process.env.HANDLERS || '!',
    STICKER_DATA: process.env.STICKER_DATA || "Theseus",
    ...
    SUDO: process.env.SUDO || "2394917412",
